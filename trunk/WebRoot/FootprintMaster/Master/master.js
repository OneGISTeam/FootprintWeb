...
$( document ).on( "pagecreate", ".jqm-master", function( event ) {
	var search,
		page = $( this ),
		that = this,
	...
	// Turn off autocomplete / correct for master search
	...
	if ( $( event.target ).hasClass( "jqm-master-search-results") ) {
...
$( document ).one( "pagecreate", ".jqm-master", function( event ) {
